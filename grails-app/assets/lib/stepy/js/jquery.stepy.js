...
;(function($) {
	...
	var methods = {
		init: function(options) {
        	...
        	$('<a/>', { id: id + '-back-' + index, href: 'javascript:void(0);', 'class': 'btn btn-link button-back', html: opt.backLabel }).click(function() {
        	...
        	$('<a/>', { id: id + '-next-' + index, href: 'javascript:void(0);', 'class': 'btn btn-default button-next', html: opt.nextLabel }).click(function() {
